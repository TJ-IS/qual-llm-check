...
improvement as the sole core goal plus an explicit benchmark statement."""
...
def validate_decision(payload: dict[str, Any], record_id: str) -> dict[str, Any]:
    ...
    if objective_pass != objective_expected or benchmark_pass != benchmark_expected:
    ...
    if strict_include != (objective_pass and benchmark_pass):
...
LEGACY_ANALYSIS_VERSION = "ais-basket-exclusive-objective-metric-benchmark-2020-2027-flash-v1"
...
def write_reports(
    ...
    write_markdown("strict_matches.md", "Exclusive objective-metric improvement with explicit benchmark statements", strict_matches)
