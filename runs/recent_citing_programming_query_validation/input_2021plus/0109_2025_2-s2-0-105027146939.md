...
Author keywords: Algorithm Labels; Algorithm Recognition; Algorithm Self-Implementation; Code Annotation; Maintenance; Program Comprehension
Index keywords: Codes (symbols); Computer systems programming; Labels; Optimization; Algorithm label; Algorithm recognition; Algorithm self-implementation; Code annotation; Controlled experiment; Empirical evaluations; Program comprehension; Qualitative analysis; Source codes; Support programs; Maintenance
Document type: Conference paper
Conference: 29th International Conference on Evaluation and Assessment of Software Engineering, EASE 2025
EID: 2-s2.0-105027146939
